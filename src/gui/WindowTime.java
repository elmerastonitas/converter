...
public class WindowTime extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WindowTime frame = new WindowTime();
	...
	public WindowTime() {
		...
		mntmNewMenuItem.setIcon(new ImageIcon(WindowTime.class.getResource("/imgs/home.png")));
		...
		mntmNewMenuItem_1.setIcon(new ImageIcon(WindowTime.class.getResource("/imgs/money3.png")));
		...
		mntmNewMenuItem_2.setIcon(new ImageIcon(WindowTime.class.getResource("/imgs/temperatura.png")));
		...
		mntmNewMenuItem_3.setIcon(new ImageIcon(WindowTime.class.getResource("/imgs/tiempo.png")));
		...
		mntmNewMenuItem_4.setIcon(new ImageIcon(WindowTime.class.getResource("/imgs/longitud.png")));
		...
		mntmNewMenuItem_5.setIcon(new ImageIcon(WindowTime.class.getResource("/imgs/masa.png")));
		...
		mntmNewMenuItem_6.setIcon(new ImageIcon(WindowTime.class.getResource("/imgs/ico-converter.png")));
