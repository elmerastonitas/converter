...
public class WindowMass extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WindowMass frame = new WindowMass();
	...
	public WindowMass() {
		...
		mntmNewMenuItem_1.setIcon(new ImageIcon(WindowMass.class.getResource("/imgs/home.png")));
		...
		mntmNewMenuItem_2.setIcon(new ImageIcon(WindowMass.class.getResource("/imgs/money3.png")));
		...
		mntmNewMenuItem_3.setIcon(new ImageIcon(WindowMass.class.getResource("/imgs/temperatura.png")));
		...
		mntmNewMenuItem_4.setIcon(new ImageIcon(WindowMass.class.getResource("/imgs/tiempo.png")));
		...
		mntmNewMenuItem_5.setIcon(new ImageIcon(WindowMass.class.getResource("/imgs/longitud.png")));
		...
		mntmNewMenuItem_6.setIcon(new ImageIcon(WindowMass.class.getResource("/imgs/masa.png")));
		...
		mntmNewMenuItem.setIcon(new ImageIcon(WindowMass.class.getResource("/imgs/ico-converter.png")));
